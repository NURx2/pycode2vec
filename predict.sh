...
${PYTHON} -u code2vec/code2vec.py --framework tensorflow --load ${MODEL_DIR}/saved_model_iter8 --test ${TEST_DATA} --export_code_vectors

${PYTHON} -u code2vec/code2vec.py --framework tensorflow --load ${MODEL_DIR}/saved_model_iter8 --save_t2v ${TARGET_VECTORS_FILE_PATH}
